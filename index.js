...
card.forEach(function(cards){
    cards.addEventListener("click", function(){
       ...
       document.querySelector(".contentDetail").innerHTML=`
        ...
        <div>
        <h1>Dr.Mostafa Enamul Hoque</h1>
        <p>Oral & Dental Surgeon</p>
       <p><li> BDS(CU)</li>
       <li>Fcps( p-II) Orthodontics & Dentofacial Orthopaedics</li>
        <li>Special Trained In Advance Endodontics</li>
        <li>Trained In Cosmetic Dentistry</li>
        <li>Trained In Dental Implant</li></p>
    </div>
        `
